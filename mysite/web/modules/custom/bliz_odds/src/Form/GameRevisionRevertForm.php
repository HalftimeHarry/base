...
class GameRevisionRevertForm extends ConfirmFormBase {
   ...
   * The Game revision.
   *
   * @var \Drupal\bliz_odds\Entity\GameInterface
   */
  protected $revision;
  ...
  public static function create(ContainerInterface $container) {
    ...
    $instance->gameStorage = $container->get('entity_type.manager')->getStorage('game');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage(t('Game %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\bliz_odds\Entity\GameInterface $revision
